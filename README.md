...
CookBook - это современное SPA-приложение для любителей кулинарии. Пользователи могут просматривать коллекции рецептов, искать блюда по различным критериям, сохранять понравившиеся рецепты и создавать собственные.
