...
Веб-приложение для поиска, просмотра и создания кулинарных рецептов, разработанное на Vue 3 с TypeScript.

## Описание

CookBook - это приложение для любителей кулинарии. Пользователь может листать ленту рецептов, фильтровать их по категориям, кухням, хэштегам и времени приготовления, открывать детальную страницу с ингредиентами и шагами приготовления, сохранять понравившиеся рецепты в избранное, а также добавлять собственные через форму создания.
...
- **Поиск рецептов** с фильтрацией по категориям, кухням, хэштегам и времени приготовления
- **Подробная информация** о каждом рецепте с ингредиентами и инструкциями
- **Сохранение избранных** рецептов (требуется авторизация)
- **Создание собственных рецептов** с загрузкой изображений
